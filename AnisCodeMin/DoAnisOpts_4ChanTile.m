...
opts.LSMmedfilt=[1 2 3 4]; %ch to apply median filter, in order of analysis
...
opts.wellslimit=0.0933; %needed for 'Exp R3 D1 C rex2 and rec3 10X 3'
...
opts.savePlots=0; %save plots (PDF)
