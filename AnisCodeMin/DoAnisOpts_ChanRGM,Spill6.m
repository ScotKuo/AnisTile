...
opts.LSMchanIndex=[4 3 1]; %Indices of imageChannels to analyze for Anis, in order of analysis
opts.LSMchanName={'RedCh', 'GrnCh', 'MagCh'}; %Name for imageChannel positions, in order of analysis
...
opts.RGBchanIndex=[1 2 3]; %Indices of imageChannels to analyze for Anis, in order of analysis
	%empty list means all channels; else list indices of channels explicitly
...
opts.wellslimitmax=0.6; %for ChooseWells slider, default min,max=0.02,0.2
opts.wellslimitmin=0.1; %  if cells cross well boundaries, min,max=0.1,0.6
