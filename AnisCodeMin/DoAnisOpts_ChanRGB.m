...
opts.LSMchanIndex=[3 2 1]; %Indices of imageChannels to analyze for Anis, in order of analysis
opts.LSMchanName={'Red', 'Grn', 'DNA'}; %Name for imageChannel positions, in order of analysis
