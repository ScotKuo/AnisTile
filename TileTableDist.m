function imgs=TileTableDist(imgs, setnum, DTopts)
...
if DTopts.XLSshowdir,
	coltitles={'FileRoot','DirRoot','Chan','TSize','X','Y','AnisMin', ...
		'Anis25','Anis50','Anis75','AnisMax','AngMin','Ang25','Ang50','Ang75','AngMax' };
else
	coltitles={'FileRoot','DirRoot','Chan','TSize','X','Y','AnisMin', ...
		'Anis25','Anis50','Anis75','AnisMax','AngMin','Ang25','Ang50','Ang75','AngMax' };
end
...
Export();
diary off; %not needed if not XLSsaveFileDis, but just in case
